    ...
    <?php if(count($document)): ?>
        <?php $__currentLoopData = $document; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $document): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr style='border:1px solid black'>
                ...
                <td style='border:1px solid black;text-align:center;'> <a href="http://docs.google.com/gview?url=<?php echo e(URL::to( public_path('storage\\') . $document->document)); ?>" target="_blank"><?php echo e($document->title); ?></a> </td>
...
<?php /**PATH C:\Users\USER\LaravelProject\DocumentManagementSystem\resources\views/livewire/components/documentExportPDF.blade.php ENDPATH**/ ?>